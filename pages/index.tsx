      ...
      <main className="space-y-8">
        <section>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            I make servers go{' '}
            <span className="text-green-600 dark:text-green-400 font-mono">beep boop</span>. Also a
            hobbyist traveller, part-time hiker, and a full-time chef. This is my personal page,
        ...
        <section>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Outside of work I&apos;m interested in everything *nix, open-source projects, privacy in
        ...
        <section className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            I wear a cyborg over my ear—I am profoundly deaf. Technology doesn&apos;t just power the
